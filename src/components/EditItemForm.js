...
import { addItem, fetchItems, updateItem } from "../thunks/thunks";
...
const EditItemForm = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      toast.info("updated Record succesfully!", {
        autoClose: 500,
      });
      navigation("/view");
    },
  ...
  return (
    ...
    Go to another page
      ...
      >
        ...
        <form onSubmit={formik.handleSubmit} encType="multipart/form-data" className="form">
          ...
          <div className="input-box">
            <label className="req"  htmlFor="myfile">Upload Image</label>
            <input
              type="file"
